...
public:
  ...
  virtual Data PredecessorNRemove(Data&) = 0; 
  virtual void RemovePredecessor(Data&)= 0; 

  virtual Data& Successor(const Data&) const =0; // (concrete function must throw std::length_error when not found)
  virtual Data SuccessorNRemove(Data&) = 0; // (concrete function must throw std::length_error when not found)
  virtual void RemoveSuccessor(Data&) = 0; // (concrete function must throw std::length_error when not found)
