...
public:
  ...
  // Comparison operators
  bool operator==(PreOrderMappableContainer & ) const noexcept = delete; // Comparison of abstract types is not possible.
  bool operator!=(PreOrderMappableContainer & ) const noexcept = delete; // Comparison of abstract types is not possible.
...
public:
  ...
  virtual void PostOrderMap(MapFun) = 0; //deve essere implemtentata nella sd concreta
